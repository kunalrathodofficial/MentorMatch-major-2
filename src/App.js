...
function App() {
  ...
  return (
    <div className="flex flex-col w-screen min-h-screen font-inter">
      ...
      {!navigator.onLine && (
        <div className="flex items-center justify-center gap-2 p-2 text-center text-white bg-red-500 bg-richblack-300">
          <RiWifiOffLine size={22} />
          Please check your internet connection.
          <button
            className="p-1 px-2 ml-2 text-white rounded-md bg-richblack-500"
