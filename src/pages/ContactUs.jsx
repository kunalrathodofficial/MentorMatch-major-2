...
const ContactUs = () => {
  return (
    <div>
        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 p-4 rounded-xl bg-richblack-800 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <p className='font-semibold'>info@MentorMatch.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-medium'>https://www.linkedin.com</p>
                ...
                {/* <p className='font-medium'>91+ 78283 44687</p> */}
                <p className='font-semibold'>+91 6366 000 666</p>
                </div>
            </div>
        </div>
        <div className='lg:w-[60%]'>
            <div className='flex flex-col gap-3 text-black border border-richblack-600 rounded-xl p-7 lg:p-14'>
                <h1 className='text-4xl font-semibold leading-10 text-blue'>
                Got a Idea? We've got the skills. Let's team up
                </h1>
                <p className='text-lg font-medium text-black'>Tell us more about yourself and what you're got in mind.</p>
                <div className='mt-7'>
                    <ContactUsForm/>
                </div>
            </div>
        ...
        <div className='relative flex flex-col items-center justify-between w-11/12 gap-8 mx-auto my-20 text-black max-w-maxContent '>
